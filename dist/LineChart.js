...
var multipleFills=_this.props.fillColor?
dataPoints.map(function(dataPointSet,index){
var allDisjointPaths=fillPath[index].map(function(singlePath,subIndex){
return(
_react2.default.createElement(AnimatedShape,{d:singlePath,fill:_this.props.fillColor[index],__source:{fileName:_jsxFileName,lineNumber:146}}));
...
return(
_react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:155}},
_react2.default.createElement(_reactNative.View,{style:{position:'absolute'},__source:{fileName:_jsxFileName,lineNumber:156}},
_react2.default.createElement(Surface,{width:containerWidth,height:containerHeight,__source:{fileName:_jsxFileName,lineNumber:157}},
multipleLines,
multipleFills)),


_react2.default.createElement(_reactNative.View,{style:{position:'absolute'},__source:{fileName:_jsxFileName,lineNumber:162}},
_react2.default.createElement(Surface,{width:containerWidth,height:containerHeight,__source:{fileName:_jsxFileName,lineNumber:163}})),
...
return(
_react2.default.createElement(_Circle2.default,_extends({key:i},d,{onPress:function onPress(){return alert(i);},__source:{fileName:_jsxFileName,lineNumber:171}})));
...
return(
_react2.default.createElement(Surface,{width:containerWidth,height:containerHeight,__source:{fileName:_jsxFileName,lineNumber:178}},
multipleDataPoints));
...
return(
_react2.default.createElement(_reactNative.View,{style:{overflow:'hidden'},__source:{fileName:_jsxFileName,lineNumber:190}},
_react2.default.createElement(_Grid2.default,_extends({},this.props,{__source:{fileName:_jsxFileName,lineNumber:191}})),
_react2.default.createElement(_reactNative.Animated.View,{style:{height:this.state.height,opacity:this.state.opacity,backgroundColor:'transparent'},__source:{fileName:_jsxFileName,lineNumber:192}},
this._drawLine())));
...
return(
_react2.default.createElement(_reactNative.View,{__source:{fileName:_jsxFileName,lineNumber:199}},
_react2.default.createElement(_Grid2.default,_extends({},this.props,{__source:{fileName:_jsxFileName,lineNumber:200}})),
_react2.default.createElement(_reactNative.View,{style:{height:this.props.height},__source:{fileName:_jsxFileName,lineNumber:201}},
this._drawLine())));
